...
// in todo_list/test/viewmodels/add_task_view_model_test.dart.
...
import 'package:todo_list/services/user/user_service.dart' as _i3;
...
class MockUserService extends _i1.Mock implements _i3.UserService {
  ...
  @override
  _i4.Future<_i2.DocumentSnapshot<Map<String, dynamic>>?> getUserByEmail(
    String? email,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<List<String>> searchEmails(String? query) =>
      (super.noSuchMethod(
            Invocation.method(#searchEmails, [query]),
